...
class Status extends SearchPipe
{
    protected function searchFieldName(): string
    {
        return (SearchFields::STATUS)->value;
    }

    protected function addConditionToBuilder(Passable $passable)
    {
        $this->whereCondition($passable, AddTableToProductField::addTableToProductField(Product::STATUS));
    }
}
